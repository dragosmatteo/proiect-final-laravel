<template>
    <div id="wrapper">
        ...
        <div class="sidebar" :class="{ showOverlay: overlayVisibility }">
            ...
            <p class="brand-title"><a href="/">Fii Practic</a></p>
            ...
            <footer class="sidebar-footer">
                <div>
                    <a
                        href="https://www.facebook.com/fiipractic"
                        target="_blank"
                        ><i class="fab fa-facebook-f"></i
                    ></a>
                </div>

                <small>&copy; 2023 Fii Practic</small>
            </footer>
        </div>
        <!-- Menu Button -->
        ...
        <footer class="main-footer">
            <div>
                <a href="https://www.facebook.com/fiipractic" target="_blank"
                    ><i class="fab fa-facebook-f"></i
                ></a>
            </div>
            <small>&copy; 2023 Fii Practic</small>
